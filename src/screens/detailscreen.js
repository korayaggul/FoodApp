...
<TouchableOpacity style={styles.starCooking} >
    ...
    <View>
      <Text style={styles.barText}>Nutrition Information per Serving</Text>
    </View>
    <View style={styles.progressBar}>
     <ProgressBar count={count} valueText={valueCalorie} text="CAL" value={calorieNumber}/>
     <ProgressBar count={count} valueText={valueOil} text="FAT" value={oilNumber} weight="g"/>
     <ProgressBar count={count} valueText={valueCarbs} text="CARBS" value={carbsNumber} weight="g"/>
     <ProgressBar count={count} valueText={valueProtein} text="PROT" value={proteinNumber} weight="g"/>
     </View>
    </View>
    </View>
    </View>
    ...
    <Icon name="cart-outline" size={30} color="white"/>
      ...
      <Text style={styles.footerButtonText}>Add Missing Ingredients ({count})</Text>
